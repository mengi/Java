...
%>
	<form class="form-horizontal"
		...
		<input type="hidden" name="islem" value="ReklamBilgisiDuzenle">
		<fieldset>
				...
				<table class="table table-bordered" style="font-size: small;">
							...
							if (ListelenecekReklamlar.size() > 0) {
								for (; satirNo < ListelenecekReklamlar.size(); satirNo++) {
									...
									if (Reklam.getReklamIcerik().length() > 25)
										reklamIcerik = Reklam.getReklamIcerik().substring(0, 25)+"...";
									else
					...
					<tr>
						...
						<td style="text-align: center;"><a
							title="<%=Reklam.getReklamIcerik() %>"><%=reklamIcerik %></a></td>
